import { getWeb3Provider as getMailProvider } from '@iexec/web3mail';
import { getWeb3Provider as getProtectorProvider } from '@iexec/dataprotector';
...
const sendMailToAddresses = async (
    emailSubject,
    emailContent,
    addresses,
    throwable = false,
    platformName,
    providedDataProtector,
    providedWeb3mail
) => {
